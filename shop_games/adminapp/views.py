...
def categories(request):
    ...
    categories_list = GamesCategory.objects.all()
...
def products(request, pk):
    ...
    products_list = Games.objects.filter(category__pk=pk).order_by('name')
...
def product_read(request, pk):
    ...
    product = get_object_or_404(Games, pk=pk)
...
def product_update(request, pk):
    ...
    edit_product = get_object_or_404(Games, pk=pk)
